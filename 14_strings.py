...
44. title           Convierte la cadena a formato título (Cada una de las palabras con la primera letra mayuscula).
...
if 'Python' in text:
    print('Si se encuentra dentro del texto')
